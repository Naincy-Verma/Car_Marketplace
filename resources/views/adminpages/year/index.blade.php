...
<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.years.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded">+ Add Year</a>
    </div>
                ...
                @forelse ($years as $year)
                    <tr class="border-b border-gray-700 hover:bg-gray-700">
                        ...
                        <td class="py-2 px-4 text-center">
                            <a href="{{ route('admin.years.edit', $year->id) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1 rounded">Edit</a>
                            <form action="{{ route('admin.years.destroy', $year->id) }}" method="POST" class="inline">
                                @csrf @method('DELETE')
